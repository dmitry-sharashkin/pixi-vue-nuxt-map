...
export default {
  ...
  methods: {
    ...
    drawPixi() {
      ...
      let mapContainerWrap = new Container();

      mapContainerWrap.interactive = true;
      mapContainerWrap.buttonMode = true;
      mapContainerWrap.on("mousedown", (event) => console.log(event));
      ...
      fSegments.forEach(function (item, index) {
        ...
        sprite.mouseover = (mouseData) => {
          activeSegment.beginFill(0xfff000);
          activeSegment.moveTo(x + halfCordFactor, y);
          activeSegment.lineTo(x + cordFactor, y - cordFactor);
          activeSegment.lineTo(x + cordFactor, y + cordFactor);
          activeSegment.lineTo(x + halfCordFactor, y);
      ...
      mapContainerWrap.addChild(mapContainer);
      app.stage.addChild(mapContainerWrap);
    },
  },
};
</script>
